...
myGrid0 = LEDGrid(ip=ip_list[0],n_leds=190)
...
myGrid0.set_theme("sub")
myGrid0.set_active("active")

myGrid1 = LEDGrid(ip=ip_list[1],n_leds=190)
...
myGrid1.set_theme("sub")
myGrid1.set_active("active")

myGrid2 = LEDGrid(ip=ip_list[2],n_leds=190)
...
myGrid3 = LEDGrid(ip=ip_list[3],n_leds=190)
...
myGrid4 = LEDGrid(ip=ip_list[4],n_leds=190)
...
myGrid5 = LEDGrid(ip=ip_list[5],n_leds=190)
...
myGrid6 = LEDGrid(ip=ip_list[6],n_leds=190)
...
myGrid7 = LEDGrid(ip=ip_list[7],n_leds=190)
...
myGrid8 = LEDGrid(ip=ip_list[8],n_leds=190)
...
myGrid9 = LEDGrid(ip=ip_list[9],n_leds=190)
...
myGrid10 = LEDGrid(ip=ip_list[10],n_leds=190)
...
myGrid11 = LEDGrid(ip=ip_list[11],n_leds=190)
...
myGrid12 = LEDGrid(ip=ip_list[12],n_leds=190)
...
myGrid13 = LEDGrid(ip=ip_list[13],n_leds=190)
...
myGrid14 = LEDGrid(ip=ip_list[14],n_leds=190)
...
myGrid15 = LEDGrid(ip=ip_list[15],n_leds=190)
...
myGrid16 = LEDGrid(ip=ip_list[16],n_leds=190)
...
myGrid17 = LEDGrid(ip=ip_list[17],n_leds=190)
...
myGrid18 = LEDGrid(ip=ip_list[18],n_leds=190)
...
myGrid19 = LEDGrid(ip=ip_list[19],n_leds=190)
