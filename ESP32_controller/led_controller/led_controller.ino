...
- Use the Arduino IDE - Manage Libraries to search for and add these
*/

// See reference - https://github.com/kitesurfer1404/WS2812FX/blob/master/examples/esp8266_webinterface/esp8266_webinterface.ino
